  ...
  return (
    <>
      ...
      <div className="relative flex flex-col h-full bg-gray-900 text-white overflow-hidden">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-gray-800 p-3 rounded-lg">
                <h3 className="text-[10px] font-medium text-gray-400 uppercase">Garantía Depositada</h3>
                <p className="text-lg font-bold text-green-400">Bs {Math.floor(guaranteeBalance).toLocaleString('es-ES')}</p>
              </div>
              <div className="bg-gray-800 p-3 rounded-lg">
                <h3 className="text-[10px] font-medium text-gray-400 uppercase">Garantía Restante</h3>
                <p className={`text-lg font-bold ${guaranteeRemaining > 0 ? 'text-cyan-400' : 'text-red-400'}`}>
                  Bs {Math.floor(guaranteeRemaining).toLocaleString('es-ES')}
                </p>
              </div>
              <div className="bg-gray-800 p-3 rounded-lg">
                <h3 className="text-[10px] font-medium text-gray-400 uppercase">Cartones Vendidos</h3>
                <p className="text-lg font-bold text-white">{myCartonesCount}</p>
              </div>
              <div className="bg-gray-800 p-3 rounded-lg">
                <h3 className="text-[10px] font-medium text-gray-400 uppercase">Comisión ({commissionRate}%)</h3>
                <p className="text-lg font-bold text-yellow-400">Bs {Math.floor(commissionConsumed).toLocaleString('es-ES')}</p>
              </div>
            </div>
        ...
        {/* Bottom Nav */}
        <nav className="absolute bottom-6 left-4 right-4 bg-[#020617]/95 backdrop-blur-xl border border-slate-700/50 rounded-[2rem] z-40 shadow-2xl shadow-purple-900/20 overflow-hidden">
