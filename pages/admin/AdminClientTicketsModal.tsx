...
const AdminClientTicketsModal: React.FC<AdminClientTicketsModalProps> = ({ client, cartones, jornadas, onClose, onViewCarton }) => {
    return (
                    ...
                    {cartones.length > 0 ? (
                        cartones.sort((a, b) => new Date(b.purchaseDate).getTime() - new Date(a.purchaseDate).getTime()).map(carton => {
                         ...
                         <div className="text-center py-8">
                            <p className="text-gray-400">Este usuario aún no ha comprado ningún cartón.</p>
                        </div>
                    )}
                </div>
...
export default AdminClientTicketsModal;