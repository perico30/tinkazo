                        ...
                        <div className="p-4 border-t border-gray-700 bg-gray-800/50">
                            <div className="flex justify-between items-center mb-3">
                                ...
                                <div className="flex gap-4 items-center">
                                    <button onClick={() => handleCheckFT(jornada)} disabled={checkingFT === jornada.id} className="text-yellow-400 text-sm font-semibold hover:text-yellow-300 disabled:opacity-50">
