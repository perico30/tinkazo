...
const RegisterPage: React.FC<RegisterPageProps> = ({ setCurrentView, primaryColor, onRegister }) => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl shadow-cyan-500/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full text-gray-900 font-bold py-3 rounded-lg transition-colors mt-6 shadow-lg transform hover:scale-105"
